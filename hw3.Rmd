...
```
What does the result show? Do these results make any sense? Answer:
...
Q.13
Modify the `textProcessor` function to use the same set of stopwords as used in the analysis above. You will also need to modify the `removestopwords` argument, otherwise the model will remove the stopwords above and those in the preset lexicon. *Note: It make take a couple of minutes for this chunk to run.*
